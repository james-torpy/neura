...
split_number_1 = (row_number/2)
split_number_2 = (row_number/2) + 1
sample_overlaps_a = sample_overlaps[1:split_number_1, ]
sample_overlaps_b = sample_overlaps[split_number_2:row_number, ]
###
...
sample_overlaps_boxplot = ggplot(sample_overlaps_phenotype_sorted, aes(x=reorder(Transcript_ID, -Median), y=Overlap_count_per_million_reads)
