...
sample_overlaps_boxplot = ggplot(sample_overlaps, aes(x=reorder(Transcript_ID, -Median), y=Overlap_count_per_million_reads)
) + geom_point (aes(colour=phenotype, fill=phenotype)
), position = position_jitterdodge(jitter.width = 1.0, jitter.height = 0, dodge.width=0.75
