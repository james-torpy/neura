...
pdf("/home/jamtor/projects/neura/results/stanley_pc.overlaps/sample_overlaps_pheatmap_log2.pdf", width=16, height=12)
sample_overlaps_pheatmap = sample_overlaps_pheatmap + 1
sample_overlaps_pheatmap_log2 = log2(sample_overlaps_pheatmap)
pheatmap(sample_overlaps_pheatmap_log2, main = "Expression of transcripts linked to schizophrenia in schizophrenia patients", fontsize = 14)
dev.off()
